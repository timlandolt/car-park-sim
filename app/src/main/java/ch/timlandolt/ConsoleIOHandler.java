...
public class ConsoleIOHandler implements IOHandler {
    ...
    public ConsoleIOHandler(CarPark carPark) {
    ...
    private void buyTicket(Scanner scanner, CarPark carPark) {
        ...
        while (true) {
            int floors = carPark.getFloorCount();
            ...
            do {
                int spacesPerFloor = carPark.getSpacesPerFloor();
    ...
    private void payParkingFee(Scanner scanner, CarPark carPark) {
    ...
    private void exitCarPark(Scanner scanner, CarPark carPark) {
        TicketMachine ticketMachine = carPark.getTicketMachine();
    ...
    private void lookAtDisplay(CarPark carPark) {
